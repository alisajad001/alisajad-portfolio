...
const Skills = () => {
  return (
    <div className="w-full py-20 bg-gray-900">
      <div className="max-w-[1000px] h-full mx-auto p-10 relative flex flex-col justify-evenly">
        ...
        <div className="flex sm:flex-row flex-wrap justify-evenly gap-10 mt-12 items-center">
          {skills.map((skillEl) => {
            return (
              <div
                key={skillEl.id}
                className={`flex flex-col hover:translate-y-[-7px] border ${skillEl.border} bg-gray-800 w-24 rounded-lg p-3 justify-center items-center`}
              >
